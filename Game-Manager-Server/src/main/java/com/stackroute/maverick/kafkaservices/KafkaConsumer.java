...
//		kafkaConsumer.send1(category);
	...
	public void game(String gameId) throws NullPointerException {
		Game foundById = gameManagerRepository.findByGameId(Integer.parseInt(gameId));
		kafkaProducer.send(foundById);
	}
